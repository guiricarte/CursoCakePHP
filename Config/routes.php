 ...
 */
	...
	Router::connect('/palestrantes/:nome/:id', array('controller' => 'palestrantes', 'action' => 'view'), array('pass' => array('id'), 'id' => '[0-9]+' ) );
	...
	Router::connect('/sobre-nos', array('controller' => 'pages', 'action' => 'display', 'sobre-nos'));
	Router::connect('/inscricao', array('controller' => 'inscricoes', 'action' => 'inscrever'));
	Router::connect('/agradecimento', array('controller' => 'pages', 'action' => 'display', 'agradecimento'));
